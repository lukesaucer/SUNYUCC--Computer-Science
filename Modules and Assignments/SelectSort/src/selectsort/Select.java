 ...
 * @version 1.0
 * 
 * This program uses the insertion sort method to sort a given array of integers in order from
 * the smallest integer to the largest (excluding the first and last integers entered into 
 * the array).
 */
