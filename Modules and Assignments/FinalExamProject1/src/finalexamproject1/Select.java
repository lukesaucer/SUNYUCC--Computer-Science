 ...
 * @version - 1.0
 * 
 * This program uses the selection sort method to sort a given array of integers in order from
 * the smallest integer to the largest.
 */
// File: Select.java
...
public static void main(String[ ] args)
{
   ...
   System.out.println("I have sorted all the numbers.");
