...
public BTNode<E> search(int key) {
    return search(this.root, key);
}

private BTNode<E> search(BTNode<E> root, int key) {
    if (root == null) {
        return null;
...
//boolean search(int key) throws NullPointerException { 
...
//BTNode<E> search_Recursive(BTNode<E> root, int key) throws NullPointerException { 
