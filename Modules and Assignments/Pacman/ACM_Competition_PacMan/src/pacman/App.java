...
public class App extends JFrame{
  ...
  public App(){	  
	  ...
	  _game = new Board(wins1, wins2, score1, score2);
	  add(_game);
	  ...
	  setTitle("UCONN ACM - PACMAN 2013");
