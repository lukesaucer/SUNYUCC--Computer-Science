...
//File: Stack.java from the package edu.colorado.collections
//Complete documentation is available from the Stack link in:
//http://www.cs.colorado.edu/~main/docs/

import java.util.EmptyStackException;

/******************************************************************************
* An <CODE>Stack</CODE> is a stack of references to objects.
*
* <b>Limitations:</b>
*   
...
*   <A HREF="../../../../edu/colorado/collections/Stack.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/Stack.java
*   </A>
*
* @author Michael Main 
...
* @see ShortStack
******************************************************************************/
public class QueueDemo<E> implements Cloneable
{
...
**/   
public QueueDemo(int initialCapacity)
{
...
*   value must be type cast to an <CODE>Stack</CODE> before it can be used.
* @exception OutOfMemoryError
...
try
{
answer = (QueueDemo<E>) super.clone( );
}
